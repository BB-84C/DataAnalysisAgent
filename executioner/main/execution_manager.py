...
class ExecutionManager:
    ...
    def _run_op_runtime(self, runtime_edid:str):
        ...
        tool_calls_response = tool_caller(OP_description,input_data, input_MR_Description, self.tool_schema)
        print(f"[Execution] Done tool call.")
        ...
        if len(output_keys) == 1 and len(mr_keys) == 1:
            ...
            result = match_output_vars_to_MRs(mr_descs, output)  # LLM returns MR list 
